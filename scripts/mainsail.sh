...
function install_mainsail_macros() {
  ...
  while true; do
    ...
    echo -e "| https://github.com/MOMENT3D/mainsail-config      |"
    blank_line
...
function download_mainsail_macros() {
  ...
  ms_cfg_repo="https://github.com/MOMENT3D/mainsail-config.git"
...
function get_remote_mainsail_version() {
  ...
  local tags
  tags=$(curl -s "https://api.github.com/repos/MOMENT3D/mainsail/tags" | grep "name" | cut -d'"' -f4)
  echo "${tags}" | head -1
}
...
function ms_theme_installer_menu() {
  ...
  local theme_csv_url="https://raw.githubusercontent.com/MOMENT3D/gb-docs/main/_data/themes.csv"
...
function get_mainsail_download_url() {
  ...
  url="https://github.com/MOMENT3D/mainsail/releases/latest/download/mainsail.zip"

  read_kiauh_ini "${FUNCNAME[0]}"
  if [[ ${mainsail_install_unstable} == "true" ]]; then
    releases_by_tag="https://api.github.com/repos/MOMENT3D/mainsail/tags"
    ...
    unstable_url="https://github.com/MOMENT3D/mainsail/releases/download/${tag}/mainsail.zip"
...
origin: https://github.com/MOMENT3D/mainsail-config.git
